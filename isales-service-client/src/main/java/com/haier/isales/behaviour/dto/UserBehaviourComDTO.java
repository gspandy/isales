/**
* @Company 青鸟软通   
* @Title: UserBehaviourComDTO.java 
...
/** 
 * @ClassName: UserBehaviourComDTO
 * @Description: t_sys_user_behaviour_complete 自动生成的对应的实体对象   
 *  
 */
public class UserBehaviourComDTO implements Serializable{
	...
	*/
	...
	/**
	 * @return the strCallTime
	 */
	public String getStrCallTime() {
		return strCallTime;
	}
	/**
	 * @param strCallTime the strCallTime to set
	 */
