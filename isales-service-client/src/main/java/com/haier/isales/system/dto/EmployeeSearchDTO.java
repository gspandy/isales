...
public class EmployeeSearchDTO implements Serializable {
	...
	*/ 
	...
	private String grantStatus;//是否授权状态标志 已授权          未授权
	private Long operatorId;//关联是否授权成登录用户使用
	
	/** 
	* <p>Description: </p> 
	* @author Cao Rui
	* @date 2014-10-31 上午9:39:54  
	*/ 
	...
	/*=====================toString=====================*/
	/**
	* <p>Description: EmployeeSearchDTO自动生成的toString方法</p> 
	* @author Cao Rui
	* @date 2015-1-7 下午6:55:09
	* @return 
	* @see java.lang.Object#toString() 
	*/ 
	@Override
	public String toString() {
		return "EmployeeSearchDTO [employeeSn=" + employeeSn
				+ ", employeeName=" + employeeName + ", englishName="
				+ englishName + ", gender=" + gender + ", phone=" + phone
				+ ", mobileNo=" + mobileNo + ", email=" + email + ", idCardNo="
				+ idCardNo + ", updateTime=" + updateTime + ", createTime="
				+ createTime + ", empStatusCode=" + empStatusCode
				+ ", empStatusName=" + empStatusName + ", countryName="
				+ countryName + ", companyName=" + companyName + ", buFuName="
				+ buFuName + ", departmentName=" + departmentName
				+ ", empGroupName=" + empGroupName + ", empSubGroupName="
				+ empSubGroupName + ", notesMail=" + notesMail
				+ ", personelSubAreaName=" + personelSubAreaName
				+ ", grantStatus=" + grantStatus + ", operatorId=" + operatorId
				+ "]";
	}
