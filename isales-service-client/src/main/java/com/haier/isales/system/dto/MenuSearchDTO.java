...
public class MenuSearchDTO implements Serializable{
	...
	*/ 
	private static final long serialVersionUID = -6431409750104624280L;
	/** 
	* @Fields menuId : 主键
	*/
	private Long menuId;
	...
	*/
	...
	/** 
	* @Fields loginName : 查询登录用户对应的菜单时使用
	*/ 
	private String loginName; 
	/** 
	* @Fields roleList : 根据角色code查询菜单时使用
	*/ 
...
/**
	 * @Description: 属性 roleList 的get方法 
	 * @return roleList
	 */
	...
	/**
	 * @Description: 属性 roleList 的set方法 
	 * @param roleList 
	 */
	...
	/*==================toString==================*/
	/**
	* <p>Description: MenuSearchDTO自动生成的toString方法</p> 
	* @author Cao Rui
	* @date 2015-1-7 下午6:58:32 
	* @return 
	* @see java.lang.Object#toString() 
	*/ 
	@Override
	public String toString() {
		return "MenuSearchDTO [menuId=" + menuId + ", menuName=" + menuName
				...
				+ ", menuBgcolor=" + menuBgcolor + ", loginName=" + loginName
				+ ", roleList=" + roleList + "]";
	}
}
