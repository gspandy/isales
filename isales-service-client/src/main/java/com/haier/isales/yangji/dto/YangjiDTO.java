...
public class YangjiDTO implements Serializable{

	/**
	 *  样机实体类
	 */
	private static final long serialVersionUID = -4460378557084012171L;
	...
	public String toString() {
		return "YangjiDTO [id=" + id + ", key=" + key + ", storeCode=" + storeCode + ", storeName=" + storeName
