/**
* @Company 青鸟软通   
* @Title: UserBehaviourComDomain.java 
...
/** 
 * @ClassName: UserBehaviourComDomain 
 * @Description: t_sys_user_behaviour_complete 自动生成的对应的实体对象   
 *  
 */
public class UserBehaviourComDomain implements Serializable{
	private static final long serialVersionUID = -1448430888822L;
	...
	*/
	...
	/**
	 * @return the strOperateDate
	 */
	public String getStrOperateDate() {
		return strOperateDate;
	}
	/**
	 * @param strOperateDate the strOperateDate to set
	 */
	...
	/**
	 * @Description: 属性 quitTime 的get方法 
	 * @return id
	 */
	...
	/**
	 * @Description: 属性 quitTime 的set方法 
	 * @param id 
	 */
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: UserBehaviourComDomain 自动生成的hashcode方法</p> 
	* @author lizhenwei   
	* @date 2015年11月25日  13:54:48
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:UserBehaviourComDomain 自动生成的equals方法 </p> 
	* @author lizhenwei   
	* @date 2015年11月25日  13:54:48
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UserBehaviourComDomain other =(UserBehaviourComDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:UserBehaviourComDomain 自动生成的toString方法 </p> 
	* @author lizhenwei   
	* @date 2015年11月25日  13:54:48 
	* @return 
