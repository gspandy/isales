/**
* @Company 青鸟软通   
* @Title: DubboMonitorLoggerImpl.java 
...
import com.haier.isales.system.monitor.dao.DubboMonitorLogDAO;
import com.haier.isales.system.monitor.domain.DubboMonitorLogDomain;

/** 
 * @ClassName: DubboMonitorLoggerImpl 
 * @Description: dubbo 信息的监控日志记录功能
 *  
 */
public class DubboMonitorLoggerImpl extends BanaAspectMonitor{
	...
	*/ 
	...
	protected void doSaveMonitorLog(BanaAspectMonitorLog monitorLog) {
		DubboMonitorLogDAO dubboMonitorLogDao = SpringApplicationContextHolder.getBean("dubboMonitorLogDAO");
		dubboMonitorLogDao.save(banaAspectMonitorLogToDubboMonitorLogDomain(monitorLog));
	}
	...
	* @return
	 */
	private DubboMonitorLogDomain banaAspectMonitorLogToDubboMonitorLogDomain(BanaAspectMonitorLog log){
		DubboMonitorLogDomain entity = new DubboMonitorLogDomain();
