/**
* @Company 青鸟软通   
* @Title: WsMonitorLogDomain.java 
* @Package com.haier.isales.system.monitor.domain 
* @author Liu Wenjie   
* @date 2014年11月19日  11:39:38 
* @version V1.0   
*/ 
package com.haier.isales.system.monitor.domain;
...
/** 
 * @ClassName: WsMonitorLogDomain 
 * t_sys_monitor_ws 自动生成的对应的实体对象   
 *  
 */
public class WsMonitorLogDomain implements Serializable{
	private static final long serialVersionUID = -1416368378426L;
	...
	*/
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: WsMonitorLogDomain 自动生成的hashcode方法</p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:38
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:WsMonitorLogDomain 自动生成的equals方法 </p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:38
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		WsMonitorLogDomain other =(WsMonitorLogDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:WsMonitorLogDomain 自动生成的toString方法 </p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:38 
	* @return 
