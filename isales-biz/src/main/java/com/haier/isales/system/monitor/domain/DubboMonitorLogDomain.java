/**
* @Company 青鸟软通   
* @Title: DubboMonitorLogDomain.java 
* @Package com.haier.isales.system.monitor.domain 
* @author Liu Wenjie   
* @date 2014年11月19日  11:39:11 
* @version V1.0   
*/ 
package com.haier.isales.system.monitor.domain;
...
/** 
 * @ClassName: DubboMonitorLogDomain 
 * t_sys_monitor_dubbo 自动生成的对应的实体对象   
 *  
 */
public class DubboMonitorLogDomain implements Serializable{
	private static final long serialVersionUID = -1416368351620L;
	...
	*/
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: DubboMonitorLogDomain 自动生成的hashcode方法</p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:11
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:DubboMonitorLogDomain 自动生成的equals方法 </p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:11
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		DubboMonitorLogDomain other =(DubboMonitorLogDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:DubboMonitorLogDomain 自动生成的toString方法 </p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:11 
	* @return 
