/**
* @Company 青鸟软通   
* @Title: JobMonitorLogDomain.java 
* @Package com.haier.isales.system.monitor.domain 
* @author Liu Wenjie   
* @date 2014年11月19日  11:39:59 
* @version V1.0   
*/ 
package com.haier.isales.system.monitor.domain;
...
/** 
 * @ClassName: JobMonitorLogDomain 
 * t_sys_monitor_job 自动生成的对应的实体对象   
 *  
 */
public class JobMonitorLogDomain implements Serializable{
	private static final long serialVersionUID = -1416368399566L;
	...
	*/
	private Long id;
	/** 
	* @Fields executeClass : 执行的定时任务类名
	*/
	private String executeClass;
	/** 
	* @Fields executeFunction : 执行的定时任务方法名称
	*/
	...
	*/
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: JobMonitorLogDomain 自动生成的hashcode方法</p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:59
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:JobMonitorLogDomain 自动生成的equals方法 </p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:59
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		JobMonitorLogDomain other =(JobMonitorLogDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:JobMonitorLogDomain 自动生成的toString方法 </p> 
	* @author Liu Wenjie   
	* @date 2014年11月19日  11:39:59 
	* @return 
