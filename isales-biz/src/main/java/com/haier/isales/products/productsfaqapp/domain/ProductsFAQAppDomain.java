/**
* @Company 青鸟软通   
* @Title: ProductsFAQAppDomain.java 
* @Package com.haier.isales.products.productsfaqapp.domain 
* @author John.Zhao   
...
/** 
 * @ClassName: ProductsFAQAppDomain 
 * t_isales_products_faq 自动生成的对应的实体对象   
 *  
 */
public class ProductsFAQAppDomain implements Serializable{
	private static final long serialVersionUID = -1422410615458L;
	...
	*/
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: ProductsFAQAppDomain 自动生成的hashcode方法</p> 
	* @author John.Zhao   
	* @date 2015年01月28日  10:03:35
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:ProductsFAQAppDomain 自动生成的equals方法 </p> 
	* @author John.Zhao   
	* @date 2015年01月28日  10:03:35
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		ProductsFAQAppDomain other =(ProductsFAQAppDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:ProductsFAQAppDomain 自动生成的toString方法 </p> 
	* @author John.Zhao   
	* @date 2015年01月28日  10:03:35 
	* @return 
