///**
// * @Company 青鸟软通   
// * @Title: HereProductInterface.java 
// * @Package com.haier.isales.products.service.impl 
// * @author John.zhao   
// * @date 2015-1-15 下午4:42:17 
// * @version V1.0   
// */
//package com.haier.isales.products.service.impl;
//
...
//
///**
// * @ClassName: HereProductInterface
// * @Description: 调用海尔HERE接口获取产品百科
// * 
// */
//public class HereProductInterface {
//
//	private static Logger logger = Logger.getLogger(HereProductInterface.class);
//
...
//        logger.info("请求得到得视图信息为："+returnViewResult);
//        logger.info("开始输出查询的站点下的所有视图信息");
//        showChnlViewBySiteResult(JSONObject.fromObject(returnViewResult),siteNameVal);
//        logger.info("结束输出查询的站点下的所有视图信息");
//        /**
...
//        if (!siteAndViewObj.get("providersuccess").equals("true")||JSONArray.fromObject(siteAndViewObj.get(siteNameVal)).isEmpty()){
...
//                   String sProParams="{sitename:'"+siteNameVal+"',viewname:'"+currentViewObj.get("viewname").toString()+"',pagesize:'20',curpage:'1',selectfields:'"+viewPropertiesResult+"','extcondition':[{'fieldname':'taotu','num':'10'}]}";
//                   //打印返回的结果
...
//
//    }
//    public void showViewProductInfo(String productInfo){
//        try{
...
//                   logger.info("查询站点"+siteName+"下的所有产品视图信息为："+ JSONArray.fromObject(providerData.get(siteName)));
//               }else{
//                   logger.info("查询数据出错。");
//               }
//          }else{
//              logger.info("调用接口出现问题，其原因是："+returnResult);
//          }
//    }
//    //调用接口的公共方法
...
//        HereProductInterface code=new HereProductInterface();
//        try {
//        	logger.info("**********************规格参数 分割线start**************************");
//            //code.getAllProductInfo(siteName,fieldGroups1);
//            logger.info("**********************规格参数 分割线结束**************************");
//            logger.info("**********************产品特性 分割线开始**************************");
//            code.getAllProductInfo(siteName,fieldGroups2);
//            logger.info("**********************产品特性 分割线结束**************************");
//            logger.info("**********************用户评论 分割线开始**************************");
//            //code.getAllProductInfo(siteName,fieldGroups3);
//            logger.info("**********************用户评论 分割线结束**************************");
//            logger.info("**********************说明书 分割线开始**************************");
//           // code.getAllProductInfo(siteName,fieldGroups4);
//            logger.info("**********************说明书 分割线结束**************************");
//            logger.info("**********************常见问题 分割线开始**************************");
//            //code.getAllProductInfo(siteName,fieldGroups5);
//            logger.info("**********************常见问题 分割线结束**************************");
