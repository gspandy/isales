/**
* @Company 青鸟软通   
* @Title: ProductsBookDomain.java 
* @Package com.haier.isales.products.productsbook.domain 
* @author John.Zhao   
* @date 2015年01月22日  16:45:15 
* @version V1.0   
*/ 
package com.haier.isales.products.heretemp.productsbook.domain;

import java.io.Serializable;

/** 
 * @ClassName: ProductsBookDomain 
 * t_isales_products_book_temp 自动生成的对应的实体对象   
 *  
 */
public class ProductsBookDomain implements Serializable{
	private static final long serialVersionUID = -1421916315458L;

	/** 
	* @Fields id : 本系统子增长主键，无意义
	*/
	private Long id;
	/** 
	...
	*/
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: ProductsBookDomain 自动生成的hashcode方法</p> 
	* @author John.Zhao   
	* @date 2015年01月22日  16:45:15
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:ProductsBookDomain 自动生成的equals方法 </p> 
	* @author John.Zhao   
	* @date 2015年01月22日  16:45:15
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		ProductsBookDomain other =(ProductsBookDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:ProductsBookDomain 自动生成的toString方法 </p> 
	* @author John.Zhao   
	* @date 2015年01月22日  16:45:15 
	* @return 
