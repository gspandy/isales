...
/** 
 * @ClassName: PersonalInfoDomain 
 * T_SYS_Employee 自动生成的对应的实体对象   
 *  
 */
public class PersonalInfoDomain implements Serializable{
	private static final long serialVersionUID = -1415690510205L;
	...
	*/
	...
	//修改一下部分get set方法的格式，以修复代码违规：“源文件最长不要超过800行”
	/**
	 * 属性 organalysisattr4 的get方法 
	 * @return id
	 */
	public String getOrganalysisattr4() {return this.organalysisattr4;}
	/**
	 * 属性 organalysisattr4 的set方法 
	 * @param id 
	 */
	public void setOrganalysisattr4(String organalysisattr4) {this.organalysisattr4 = organalysisattr4;}
	/**
	 * 属性 organalysisattr2 的get方法 
	 * @return id
	 */
	public String getOrganalysisattr2() {return this.organalysisattr2;}
	/**
	 * 属性 organalysisattr2 的set方法 
	 * @param id 
	 */
	public void setOrganalysisattr2(String organalysisattr2) {this.organalysisattr2 = organalysisattr2;}
	/**
	 * 属性 organalysisattr3 的get方法 
	 * @return id
	 */
	public String getOrganalysisattr3() {return this.organalysisattr3;}
	/**
	 * 属性 organalysisattr3 的set方法 
	 * @param id 
	 */
	public void setOrganalysisattr3(String organalysisattr3) {this.organalysisattr3 = organalysisattr3;}
	/**
	 * 属性 organalysisattr1 的get方法 
	 * @return id
	 */
	public String getOrganalysisattr1() {return this.organalysisattr1;}
	/**
	 * 属性 organalysisattr1 的set方法 
	 * @param id 
	 */
	public void setOrganalysisattr1(String organalysisattr1) {this.organalysisattr1 = organalysisattr1;}
	/**
	 * 属性 manageOrgCode 的get方法 
	 * @return id
	 */
	public String getManageOrgCode() {return this.manageOrgCode;}
	/**
	 * 属性 manageOrgCode 的set方法 
	 * @param id 
	 */
	public void setManageOrgCode(String manageOrgCode) {this.manageOrgCode = manageOrgCode;}
	/**
	 * 属性 glkhName 的get方法 
	 * @return id
	 */
	public String getGlkhName() {return this.glkhName;}
	/**
	 * 属性 glkhName 的set方法 
	 * @param id 
	 */
	public void setGlkhName(String glkhName) {this.glkhName = glkhName;}
	/**
	 * 属性 buid 的get方法 
	 * @return id
	 */
	public String getBuid() {return this.buid;}
	/**
	 * 属性 buid 的set方法 
	 * @param id 
	 */
	 ...
	 * @return id
	 */
	public String getBuName() {return this.buName;}
	/**
	 * 属性 buName 的set方法 
	 * @param id 
	 */
	 ...
	 * @return id
	 */
	public String getRzlx() {return this.rzlx;}
	/**
	 * 属性 rzlx 的set方法 
	 * @param id 
	 */
	public void setRzlx(String rzlx) {this.rzlx = rzlx;}
	/**
	 * 属性 hmcId 的get方法 
	 * @return id
	 */
	public String getHmcId() {return this.hmcId;}
	/**
	 * 属性 hmcId 的set方法 
	 * @param id 
	 */
	public void setHmcId(String hmcId) {this.hmcId = hmcId;}
	/**
	 * 属性 hname 的get方法 
	 * @return id
	 */
	...
	/**
	 * 属性 marketGroup 的get方法 
	 * @return id
	 */
	public String getMarketGroup() {return this.marketGroup;}
	/**
	 * 属性 marketGroup 的set方法 
	 * @param id 
	 */
	public void setMarketGroup(String marketGroup) {this.marketGroup = marketGroup;}
	/**
	 * 属性 haierCode 的get方法 
	 * @return id
	 */
	public String getHaierCode() {return this.haierCode;}
	/**
	 * 属性 haierCode 的set方法 
	 * @param id 
	 */
	public void setHaierCode(String haierCode) {this.haierCode = haierCode;}
	/**
	 * 属性 gwType 的get方法 
	 * @return id
	 */
	public String getGwType() {return this.gwType;}
	/**
	 * 属性 gwType 的set方法 
	 * @param id 
	 */
	public void setGwType(String gwType) {this.gwType = gwType;}
	/**
	 * 属性 gwId 的get方法 
	 * @return id
	 */
	public String getGwId() {return this.gwId;}
	/**
	 * 属性 gwId 的set方法 
	 * @param id 
	 */
	 ...
	 * @return id
	 */
	public String getGwName() {return this.gwName;}
	/**
	 * 属性 gwName 的set方法 
	 * @param id 
	 */
	 ...
	 * @return id
	 */
	public String getHsex() {return this.hsex;}
	/**
	 * 属性 hsex 的set方法 
	 * @param id 
	 */
	public void setHsex(String hsex) {this.hsex = hsex;}
	/**
	 * 属性 ryfl 的get方法 
	 * @return id
	 */
	public String getRyfl() {return this.ryfl;}
	/**
	 * 属性 ryfl 的set方法 
	 * @param id 
	 */
	public void setRyfl(String ryfl) {this.ryfl = ryfl;}
	/**
	 * 属性 nation 的get方法 
	 * @return id
	 */
	 ...
	 * @return id
	 */
	public String getRbtbdate() {return this.rbtbdate;}
	/**
	 * 属性 rbtbdate 的set方法 
	 * @param id 
	 */
	public void setRbtbdate(String rbtbdate) {this.rbtbdate = rbtbdate;}
	/**
	 * 属性 pactksDate 的get方法 
	 * @return id
	 */
	public String getPactksDate() {return this.pactksDate;}
	/**
	 * 属性 pactksDate 的set方法 
	 * @param id 
	 */
	public void setPactksDate(String pactksDate) {this.pactksDate = pactksDate;}
	/**
	 * 属性 pactjsDate 的get方法 
	 * @return id
	 */
	public String getPactjsDate() {return this.pactjsDate;}
	/**
	 * 属性 pactjsDate 的set方法 
	 * @param id 
	 */
	public void setPactjsDate(String pactjsDate) {this.pactjsDate = pactjsDate;}
	/**
	 * 属性 pactunit 的get方法 
	 * @return id
	 */
	public String getPactunit() {return this.pactunit;}
	/**
	 * 属性 pactunit 的set方法 
	 * @param id 
	 */
	public void setPactunit(String pactunit) {this.pactunit = pactunit;}
	/**
	 * 属性 hmail 的get方法 
	 * @return id
	 */
	 ...
	 * @return id
	 */
	public String getRhaierDate() {
		return this.rhaierDate;
	}
	/**
	 * 属性 rhaierDate 的set方法 
	 * @param id 
	 */
	public void setRhaierDate(String rhaierDate) {
		this.rhaierDate = rhaierDate;
	}
	/**
	 * 属性 haierPactunit 的get方法 
	 * @return id
	 */
	public String getHaierPactunit() {
		return this.haierPactunit;
	}
	/**
	 * 属性 haierPactunit 的set方法 
	 * @param id 
	 */
	public void setHaierPactunit(String haierPactunit) {
		this.haierPactunit = haierPactunit;
	}
	/**
	 * 属性 gwjb 的get方法 
	 * @return id
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: PersonalInfoDomain 自动生成的hashcode方法</p> 
	* @author Cao Rui   
	* @date 2014年11月11日  15:21:50
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:PersonalInfoDomain 自动生成的equals方法 </p> 
	* @author Cao Rui   
	* @date 2014年11月11日  15:21:50
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		PersonalInfoDomain other =(PersonalInfoDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:PersonalInfoDomain 自动生成的toString方法 </p> 
	* @author Cao Rui   
	* @date 2014年11月11日  15:21:50 
	* @return 
