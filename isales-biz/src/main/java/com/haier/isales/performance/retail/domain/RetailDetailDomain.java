...
/** 
 * @ClassName: RetailDetailDomain 
 * @Description: t_isales_btb_usr_xl_complete_detail 自动生成的对应的实体对象   
 *  
 */
public class RetailDetailDomain implements Serializable{
	private static final long serialVersionUID = -1464076396752L;
	...
	*/
	...
	/** 
	* @Fields prodCode : 产品编码
	*/
	private String prodCode;
	/** 
	* @Fields prodName : 型号名称
	*/
	...
	*/
	private String tc;
	/** 
	* @Fields mtlCodeMonty : 销额
	*/
	private String mtlCodeMonty;
	/** 
	* @Fields memCnts : 门店人数
	*/
	private String memCnts;
	/** 
	* @Fields synchronousTime : 数据同步时间
	*/
	private java.util.Date synchronousTime;
	/** 
	* @Fields remark : 备注,本系统中添加的字段，预留以存储一些信息。在
	*/
	...
	/**
	 * @Description: 属性 prodName 的get方法 
	 * @return id
	 */
	...
	/**
	 * @Description: 属性 prodName 的set方法 
	 * @param id 
	 */
	...
	/**
	 * @Description: 属性 mtlCodeMonty 的get方法 
	 * @return id
	 */
	public String getMtlCodeMonty() {
		return this.mtlCodeMonty;
	}
	/**
	 * @Description: 属性 mtlCodeMonty 的set方法 
	 * @param id 
	 */
	public void setMtlCodeMonty(String mtlCodeMonty) {
		this.mtlCodeMonty = mtlCodeMonty;
	}
	/**
	 * @Description: 属性 memCnts 的get方法 
	 * @return id
	 */
	public String getMemCnts() {
		return this.memCnts;
	}
	/**
	 * @Description: 属性 memCnts 的set方法 
	 * @param id 
	 */
	public void setMemCnts(String memCnts) {
	...
	/*====================hashCode and equals ====================*/
/**
	* <p>Description: RetailDetailDomain 自动生成的hashcode方法</p> 
	* @author lizhenwei   
	* @date 2016年05月24日  15:53:16
	* @return 
	...
	*/ 
	...
	/**
	* <p>Description:RetailDetailDomain 自动生成的equals方法 </p> 
	* @author lizhenwei   
	* @date 2016年05月24日  15:53:16
	* @param obj
	* @return 
	...
	*/ 
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RetailDetailDomain other =(RetailDetailDomain) obj;
	...
	/*==================== toString() ====================*/
	/**
	* <p>Description:RetailDetailDomain 自动生成的toString方法 </p> 
	* @author lizhenwei   
	* @date 2016年05月24日  15:53:16 
	* @return 
