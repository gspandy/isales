...
public class FindListYangjiDomain implements Serializable{

	/**
	 * by wangp
	 */
	private static final long serialVersionUID = 2830838727463319185L;
	
	private String id;//用来更新状态
	private String title;//文件头
	private String content;//文件内容
	private String messageContent;//提醒用户的消息主体
...
//	private String userCode;
	...
	public String toString() {
		return "FindListYangjiDomain [id=" + id + ", title=" + title + ", content=" + content + ", messageContent="
